...
import PracCard from '../../components/Card/PracCard';
...
export default function PracticeProjectScreen(props) {
    ...
    <>
      <View style={styles.container}>
        ...
        <View style={styles.pageTop}>
          <Text style={styles.pageName}>MyPractice</Text>
        </View>
        <TextInput
          style={styles.input}
          value={search}
        ...
        <Text style={styles.pageTitle}>実践プロジェクト一覧</Text>
      </View>
      <View>
        <BottomBar />
      </View>
